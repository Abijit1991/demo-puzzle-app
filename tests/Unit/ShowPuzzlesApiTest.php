 ...
 * ShowPuzzlesApiTest
 *
 * Test cases to test the show puzzle api.
 *
 * @author Abijit <abijit.a.1991@gmail.com>
 *
 * @version 1.0.0
 */
class ShowPuzzlesApiTest extends TestCase
{
    /**
    ...
    public function test_show_puzzle_api_valid_data(): void
    {
        ...
        $this->assertEquals($viewData, 'student.showpuzzle');
    }
}
